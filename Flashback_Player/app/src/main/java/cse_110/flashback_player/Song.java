...
//    private Location currentLocation;
    ...
    private Map<String, Double> formatedLocation;
...
//        user.register(this);
//        userNames.put(user.getID(), user.getID());
    ...
    private void setLocations(ArrayList<Location> location){
